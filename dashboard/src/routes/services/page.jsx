  ...
  return (
    <div className={`min-h-screen p-6 ${theme.startsWith('dark') ? 'bg-gray-900' : 'bg-[#f5f9f6]'}`}>
      <div className="max-w-7xl mx-auto">
        <h1 className={`text-3xl font-bold mb-6 ${theme.startsWith('dark') ? 'text-blue-300' : 'text-blue-700'}`}>Service Management</h1>
        {/* Search and Filters */}
        ...
        <ServiceTable items={currentItems} onEdit={handleEdit} onDelete={confirmDelete} navigate={navigate} showPrice showServiceType showImage />
        <ServicePagination currentPage={currentPage} totalPages={totalPages} setCurrentPage={setCurrentPage} theme={theme} />
        {/* Modal */}
